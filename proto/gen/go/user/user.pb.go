...
func (x *GetUserResponse) GetWork() string {
	if x != nil {
		return x.Work
	}
	return ""
...
const file_user_user_proto_rawDesc = "" +
	...
	"\x04work\x18\x05 \x01(\tR\x04work2>\n" +
	"\x04User\x126\n" +
	"\aGetUser\x12\x14.user.GetUserRequest\x1a\x15.user.GetUserResponseB%Z#github.com/elzamin/air_tickets/userb\x06proto3"
